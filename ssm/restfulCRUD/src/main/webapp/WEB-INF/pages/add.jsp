...
<form:form action="${ctp }/emp" modelAttribute="employee" method="POST">
   ...
   <form:errors path="字段名"/>:显示字段的错误--%>

    lastName:<form:input path="lastName"/>${errorInfo.lastName} -或-><form:errors path="lastName"/><br/>
    email:<form:input path="email"/>${errorInfo.email} -或-><form:errors path="email"/><br/>
    gender:<br/>
